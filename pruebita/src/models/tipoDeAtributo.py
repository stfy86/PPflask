...
class TipoDeAtributo(db.Model):
    ...
    tipoDeDato = db.Column(db.String(20), nullable=False) # numerico, texto, fecha, boolean, file
    ...
    def __init__(self, nombre=None, tipoDeDato=None, detalle=None, descripcion=None, archivo=None):
